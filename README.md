...
![GitHub License](https://img.shields.io/github/license/hatamiarash7/mtrtools-overview) ![GitHub Release](https://img.shields.io/github/v/release/hatamiarash7/mtrtools-overview) ![Mozilla Add-on Version](https://img.shields.io/amo/v/mtr-tools-overview)

It's an Extension to calculate the global latency from all locations of the current [mtr.tools/global](https://mtr.tools/global) page.
...
1. Visit the [mtr.tools Overview](https://addons.mozilla.org/en-US/firefox/addon/mtr-tools-global/) add-on page and add it to your browser.
2. Open an `mtr.tools/global` page and let the results load.
