...
function updateModal(data) {
  ...
  document.getElementById("last-mean").textContent =
    last_mean.toFixed(2) + " ms";
  document.getElementById("avg-mean").textContent = avg_mean.toFixed(2) + " ms";
  document.getElementById("best-mean").textContent =
    best_mean.toFixed(2) + " ms";
  document.getElementById("worst-mean").textContent =
    worst_mean.toFixed(2) + " ms";
  ...
  avg_top5.forEach((item) => {
    ...
    valueCell.textContent = item.wrst.toFixed(2) + " ms"; // Safe assignment
